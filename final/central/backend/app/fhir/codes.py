...
LOINC_LAB = {
    ...
    "platelet":   {"code": "777-3",  "display": "Platelet count",     "unit": "10*3/uL"},
    ...
    # Tier 2 (결측률 중간, 값 + 측정 여부)
    "ast":        {"code": "1920-8", "display": "AST",                "unit": "U/L"},
    "albumin":    {"code": "1751-7", "display": "Albumin",            "unit": "g/dL"},
    "lactate":    {"code": "2524-7", "display": "Lactate",            "unit": "mmol/L"},
    "calcium":    {"code": "17861-6","display": "Calcium",            "unit": "mg/dL"},
    # Tier 3 (결측률 높음, 측정 여부 자체가 신호)
    "troponin":   {"code": "6598-7", "display": "Troponin T cardiac", "unit": "ng/mL"},
    "troponin_t": {"code": "6598-7", "display": "Troponin T cardiac", "unit": "ng/mL"},  # alias
    "bnp":        {"code": "33762-6","display": "BNP",                "unit": "pg/mL"},
    "amylase":    {"code": "1798-8", "display": "Amylase",            "unit": "U/L"},
}
